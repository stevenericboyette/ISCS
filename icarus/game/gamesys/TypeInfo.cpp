...
// BOYETTE NOTE: What in God's name . . .
...
int idTypeInfoTools::WriteVariable_r( const void *varPtr, const char *varName, const char *varType, const char *scope, const char *prefix, const int pointerDepth ) {
	...
	if ( token == "signed" ) {
		...
		/* // BOYETTE NOTE: This was a mess caused by someone at id software defining the public keyword as private. I don't believe it is necessary.
