...
// boyette projectile begin
const idEventDef AI_FindFoodProjectile( "findFoodProjectile", "d", 'e' );
// boyette projectile end
const idEventDef AI_FindEnemyAI( "findEnemyAI", "d", 'e' );
// boyette projectile begin
const idEventDef AI_FindNearestFoodProjectile( "findNearestFoodProjectile", "d", 'e' );
// boyette projectile end
// boyette space command begin
const idEventDef AI_FindNearestShipConsole( "findNearestShipConsole", "d", 'e' );
const idEventDef AI_FindNearestShipModule( "findNearestShipModule", "d", 'e' );
const idEventDef AI_GetEntityHealth(  "getEntityHealth", "E",'f' );
const idEventDef AI_GetEntityMaxHealth(  "getEntityMaxHealth", "E",'f' );
const idEventDef AI_IsFriendly(  "isFriendly", "E",'d' );
const idEventDef AI_ConsolesModuleIsBuffed(  "consolesModuleIsBuffed", "E",'d' );
const idEventDef AI_BuffConsolesModule( "buffConsolesModule", "e" );

const idEventDef AI_CreateBeamToEnt( "createBeamToEnt", "E" );
const idEventDef AI_RemoveBeamToEnt( "removeBeamToEnt" );

const idEventDef AI_ReturnModuleConsoleDamageDefName( "returnModuleConsoleDamageDefName", NULL, 's' );
const idEventDef AI_ReturnModuleConsoleRepairDefName( "returnModuleConsoleRepairDefName", NULL, 's' );
const idEventDef AI_ReturnDoorDamageDefName( "returnDoorDamageDefName", NULL, 's' );

const idEventDef AI_ShipOnBoardIsAtRedAlert( "shipOnBoardIsAtRedAlert", NULL,'d' );
const idEventDef AI_FindNearestCaptainChair( "findNearestCaptainChair", "d", 'e' );
const idEventDef AI_SitDownInCaptainChair( "sitDownInCaptainChair", "e" );
const idEventDef AI_StandUpFromCaptainChair( "standUpFromCaptainChair", "e" );
const idEventDef AI_IsSeatedInCaptainChair( "isSeatedInCaptainChair", NULL,'d' );

const idEventDef AI_StartWorkingOnConsole( "startWorkingOnConsole", "e" );
const idEventDef AI_StopWorkingOnConsole( "stopWorkingOnConsole", "e" );
const idEventDef AI_IsWorkingOnConsole( "isWorkingOnConsole", NULL,'d' );
const idEventDef AI_GetSittingAnimName( "getSittingAnimName", NULL, 's' );

const idEventDef AI_HideDefAttach( "hideDefAttach" );
const idEventDef AI_ShowDefAttach( "showDefAttach" );
const idEventDef AI_IsDefAttachHidden( "isDefAttachHidden", NULL,'d' );
const idEventDef AI_ActivateHideWeaponSkin( "activateHideWeaponSkin" );
const idEventDef AI_DeactivateHideWeaponSkin( "deactivateHideWeaponSkin" );
const idEventDef AI_IsHideWeaponSkinActive( "isHideWeaponSkinActive", NULL,'d' );

const idEventDef AI_UpdateCrewAutoModeBehavior( "updateCrewAutoModeBehavior" );
const idEventDef AI_IsMyCaptainChair(  "isMyCaptainChair", "E",'d' );

const idEventDef AI_FaceForwardOfEntity( "faceForwardOfEntity", "E" );
const idEventDef AI_FaceAbsoluteCenterOfEntity( "faceAbsoluteCenterOfEntity", "E" );

const idEventDef AI_BeginAIDialogueWithPlayer( "beginAIDialogueWithPlayer" );
const idEventDef AI_EndAIDialogueWithPlayer( "endAIDialogueWithPlayer" );
const idEventDef AI_UsesSpaceCommandDialogueBehavior( "usesSpaceCommandDialogueBehavior", NULL,'d' );
const idEventDef AI_InAIDialogueWithPlayer( "inAIDialogueWithPlayer", NULL,'d' );
const idEventDef AI_ReturnAIDialogueAnimToPlay( "returnAIDialogueAnimToPlay", NULL, 's' );
const idEventDef AI_ClearAIDialogueAnimToPlay( "clearAIDialogueAnimToPlay" );
const idEventDef AI_WaitingUntilPlayerTalksToMe( "waitingUntilPlayerTalksToMe", NULL,'d' );
...
// boyette projectile begin
const idEventDef AI_SetFoodProjectile( "setFoodProjectile", "E" );
// boyette projectile end
// boyette AI move command begin
const idEventDef AI_ReturnEntityCommandedToMoveTo( "returnEntityCommandedToMoveTo", NULL, 'e' );
const idEventDef AI_ClearEntityToMoveToByCommand( "clearEntityToMoveToByCommand" );

const idEventDef AI_ReturnEnemyDoorToAttack( "returnEnemyDoorToAttack", NULL, 'e' );
const idEventDef AI_ClearEnemyDoorToAttack( "clearEnemyDoorToAttack" );
// boyette AI move command end
...
// boyette projectile begin
const idEventDef AI_MoveCloseToEntity( "moveCloseToEntity", "e" );
// boyette projectile end
...
// boyette projectile begin
/* enable this code with caution - it might have screwed up your computer - possibly because foodprojectile doesn't exist right now
const idEventDef AI_FoodProjectileRange( "foodProjectileRange", NULL, 'f' );
const idEventDef AI_FoodProjectileRange2D( "foodProjectileRange2D", NULL, 'f' );
*/
// boyette projectile end
...
// boyette projectile begin
const idEventDef AI_GetFoodProjectile( "getFoodProjectile", NULL, 'e' );
// boyette projectile end
...
// boyette projectile begin
const idEventDef AI_LocateFoodProjectile( "locateFoodProjectile" );
// boyetteprojectile end
...
// boyette begin
const idEventDef AI_DistanceToEntity( "distanceToEntity", "E", 'f' );
const idEventDef AI_DistanceToEntity2D( "distanceToEntity2D", "E", 'f' );
// boyette end
...
CLASS_DECLARATION( idActor, idAI )
	...
	// boyette projectile begin
	EVENT( AI_FindFoodProjectile,				idAI::Event_FindFoodProjectile )
	// boyette projectile end
	EVENT( AI_FindEnemyAI,						idAI::Event_FindEnemyAI )
	// boyette projectile begin
	EVENT( AI_FindNearestFoodProjectile,		idAI::Event_FindNearestFoodProjectile )
	// boyette projectile end
	// boyette space command begin
	EVENT( AI_FindNearestShipConsole,			idAI::Event_FindNearestShipConsole )
	EVENT( AI_FindNearestShipModule,			idAI::Event_FindNearestShipModule )
	EVENT( AI_FindNearestCaptainChair,			idAI::Event_FindNearestCaptainChair )
	EVENT( AI_SitDownInCaptainChair,			idAI::Event_SitDownInCaptainChair )
	EVENT( AI_StandUpFromCaptainChair,			idAI::Event_StandUpFromCaptainChair )
	EVENT( AI_IsSeatedInCaptainChair,			idAI::Event_IsSeatedInCaptainChair )

	EVENT( AI_StartWorkingOnConsole,			idAI::Event_StartWorkingOnConsole )
	EVENT( AI_StopWorkingOnConsole,				idAI::Event_StopWorkingOnConsole )
	EVENT( AI_IsWorkingOnConsole,				idAI::Event_IsWorkingOnConsole )
	EVENT( AI_GetSittingAnimName,				idAI::Event_GetSittingAnimName )

	EVENT( AI_HideDefAttach,					idAI::Event_HideDefAttach )
	EVENT( AI_ShowDefAttach,					idAI::Event_ShowDefAttach )
	EVENT( AI_IsDefAttachHidden,				idAI::Event_IsDefAttachHidden )
	EVENT( AI_ActivateHideWeaponSkin,			idAI::Event_ActivateHideWeaponSkin )
	EVENT( AI_DeactivateHideWeaponSkin,			idAI::Event_DeactivateHideWeaponSkin )
	EVENT( AI_IsHideWeaponSkinActive,			idAI::Event_IsHideWeaponSkinActive )

	EVENT( AI_UpdateCrewAutoModeBehavior,		idAI::Event_UpdateCrewAutoModeBehavior)
	// boyet space command end
	...
	// boyette projectile begin
	EVENT( AI_SetFoodProjectile,				idAI::Event_SetFoodProjectile )
	// boyette projectile end
	// boyette AI move command begin
	EVENT( AI_ReturnEntityCommandedToMoveTo,	idAI::Event_ReturnEntityCommandedToMoveTo )
	EVENT( AI_ClearEntityToMoveToByCommand,		idAI::Event_ClearEntityToMoveToByCommand )
	EVENT( AI_ReturnEnemyDoorToAttack,			idAI::Event_ReturnEnemyDoorToAttack )
	EVENT( AI_ClearEnemyDoorToAttack,			idAI::Event_ClearEnemyDoorToAttack )
	EVENT( AI_GetEntityHealth,					idAI::Event_GetEntityHealth )
	EVENT( AI_GetEntityMaxHealth,				idAI::Event_GetEntityMaxHealth )
	EVENT( AI_IsFriendly,						idAI::Event_IsFriendly )
	EVENT( AI_ConsolesModuleIsBuffed,			idAI::Event_ConsolesModuleIsBuffed )
	EVENT( AI_BuffConsolesModule,				idAI::Event_BuffConsolesModule )

	EVENT( AI_CreateBeamToEnt,					idAI::Event_CreateBeamToEnt )
	EVENT( AI_RemoveBeamToEnt,					idAI::Event_RemoveBeamToEnt )

	EVENT( AI_ReturnModuleConsoleDamageDefName,	idAI::Event_ReturnModuleConsoleDamageDefName )
	EVENT( AI_ReturnModuleConsoleRepairDefName,	idAI::Event_ReturnModuleConsoleRepairDefName )
	EVENT( AI_ReturnDoorDamageDefName,			idAI::Event_ReturnDoorDamageDefName )

	EVENT( AI_ShipOnBoardIsAtRedAlert,			idAI::Event_ShipOnBoardIsAtRedAlert )
	EVENT( AI_IsMyCaptainChair,					idAI::Event_IsMyCaptainChair )

	EVENT( AI_FaceForwardOfEntity,				idAI::Event_FaceForwardOfEntity )
	EVENT( AI_FaceAbsoluteCenterOfEntity,		idAI::Event_FaceAbsoluteCenterOfEntity )

	EVENT( AI_BeginAIDialogueWithPlayer,		idAI::Event_BeginAIDialogueWithPlayer)
	EVENT( AI_EndAIDialogueWithPlayer,			idAI::Event_EndAIDialogueWithPlayer)
	EVENT( AI_UsesSpaceCommandDialogueBehavior,	idAI::Event_UsesSpaceCommandDialogueBehavior )
	EVENT( AI_InAIDialogueWithPlayer,			idAI::Event_InAIDialogueWithPlayer )
	EVENT( AI_ReturnAIDialogueAnimToPlay,		idAI::Event_ReturnAIDialogueAnimToPlay )
	EVENT( AI_ClearAIDialogueAnimToPlay,		idAI::Event_ClearAIDialogueAnimToPlay )
	EVENT( AI_WaitingUntilPlayerTalksToMe,		idAI::Event_WaitingUntilPlayerTalksToMe )
	// boyette AI move command end
	...
	// boyette projectile begin
	EVENT( AI_MoveCloseToEntity,				idAI::Event_MoveCloseToEntity )
	// boyette projectile end
	...
	// boyette projectile begin
	/* enable this code with caution - it might have screwed up your computer - possibly because foodprojectile doesn't exist right now
	EVENT( AI_FoodProjectileRange,						idAI::Event_FoodProjectileRange )
	EVENT( AI_FoodProjectileRange2D,						idAI::Event_FoodProjectileRange2D )
	*/
	// boyette projectile end
	...
	// boyette projectile begin
	EVENT( AI_GetFoodProjectile,				idAI::Event_GetFoodProjectile )
	// boyette projectile end
	...
	// boyette projectile begin
	EVENT( AI_LocateFoodProjectile,				idAI::Event_LocateFoodProjectile )
	// boyette projectile end
	...
	// boyette begin // I noticed after I created these that they already had one of these defined in the base idEntity class(obviously I should have known). But I will leave them here becuase I use them in the scripts and I felt accomplishment when I made them..
	EVENT( AI_DistanceToEntity,						idAI::Event_DistanceToEntity )
	EVENT( AI_DistanceToEntity2D,					idAI::Event_DistanceToEntity2D )
	// boyette end
...
void idAI::Event_LookAtEntity( idEntity *ent, float duration ) {
	...
	if ( ( ent != focusEntity.GetEntity() ) || ( focusTime < gameLocal.time ) ) {
		...
		//blink_time = 0; // BOYETTE NOTE IMPORTANT: I'm not sure why this is here. This seems to mess up blinking if it is called repeatedly.
	}
...
/*
=====================
idAI::Event_GetFoodProjectile
=====================
*/
void idAI::Event_GetFoodProjectile( void ) {
	idThread::ReturnEntity( foodprojectile.GetEntity() );
}


/*
=====================
idAI::Event_FindFoodProjectile
=====================
*/
void idAI::Event_FindFoodProjectile( int useFOV ) {
	int			i;
	idEntity	*ent;
	sbFoodProjectile		*actor;

	if ( gameLocal.InPlayerPVS( this ) ) {
		for ( i = 0; i < gameLocal.num_entities ; i++ ) {
			ent = gameLocal.entities[ i ];

			if ( !ent || !ent->IsType( sbFoodProjectile::Type ) ) {
				continue;
			}

			actor = static_cast<sbFoodProjectile *>( ent );
...
/*
=====================
idAI::Event_SetFoodProjectile
=====================
*/
void idAI::Event_SetFoodProjectile( idEntity *ent ) {
	if ( !ent ) {
		ClearEnemy();
	} else if ( !ent->IsType( idActor::Type ) ) {
		gameLocal.Error( "'%s' is not an idActor (player or ai controlled character)", ent->name.c_str() );
...
/*
================
idAI::Event_LocateFoodProjectile
================
*/
void idAI::Event_LocateFoodProjectile( void ) {
	idActor *enemyEnt;
	int areaNum;
...
/*
=====================
idAI::Event_FindNearestFoodProjectile
=====================
*/
void idAI::Event_FindNearestFoodProjectile( int useFOV ) {
	idEntity	*ent;
	sbFoodProjectile	*actor;
	sbFoodProjectile	*bestEnemy;
	float		bestDist;
	float		dist;
	idVec3		delta;
	pvsHandle_t pvs;
	...
	for ( ent = gameLocal.spawnedEntities.Next(); ent != NULL; ent = ent->spawnNode.Next() ) {
		if ( !ent->IsType( sbFoodProjectile::Type ) ) {
			continue;
		}
...
/*
=====================
idAI::Event_FindNearestCaptainChair
=====================
*/
// DONE: // we have verified that we are the captain of the ship we are aboard in the script with IsMyCaptainChair and this is our captain chair. - BOYETTE NOTE TODO - NEED TO VERIFY THAT THE CHAIR IS THE CAPTAIN CHAIR OF THE PARENT SHIP. OTHERWISE WE DON'T WANT TO SIT IN IT.
void idAI::Event_FindNearestCaptainChair( int useFOV ) {
	idEntity	*ent;
	sbCaptainChair	*captainchair;
	sbCaptainChair	*bestCaptainChair;
	float		bestDist;
	float		dist;
	idVec3		delta;
	pvsHandle_t pvs;
	...
	bestDist = idMath::INFINITY;
	bestCaptainChair = NULL;
	if ( ShipOnBoard ) {
		sbCaptainChair* captainchairs[2] = {ShipOnBoard->CaptainChair,ShipOnBoard->ReadyRoomCaptainChair};
		for ( int i = 0; i < 2; ++i ) {
			if ( captainchairs[i] ) {
				if ( !gameLocal.pvs.InCurrentPVS( pvs, captainchairs[i]->GetPVSAreas(), captainchairs[i]->GetNumPVSAreas() ) ) {
					continue;
				}
				delta = physicsObj.GetOrigin() - captainchairs[i]->GetPhysics()->GetOrigin();
				dist = delta.LengthSqr();
				if ( ( dist < bestDist ) && CanSee( captainchairs[i], useFOV != 0 ) ) {
					bestDist = dist;
					bestCaptainChair = captainchairs[i];
				}
			}
		}
	} else {
		for ( ent = gameLocal.spawnedEntities.Next(); ent != NULL; ent = ent->spawnNode.Next() ) {
			if ( !ent->IsType( sbCaptainChair::Type ) ) {
				continue;
			}

			captainchair = static_cast<sbCaptainChair *>( ent );


			if ( !gameLocal.pvs.InCurrentPVS( pvs, captainchair->GetPVSAreas(), captainchair->GetNumPVSAreas() ) ) {
				continue;
			}

			delta = physicsObj.GetOrigin() - captainchair->GetPhysics()->GetOrigin();
			dist = delta.LengthSqr();
			if ( ( dist < bestDist ) && CanSee( captainchair, useFOV != 0 ) ) {
				bestDist = dist;
				bestCaptainChair = captainchair;
			}
		}
	}

	gameLocal.pvs.FreeCurrentPVS( pvs );
	idThread::ReturnEntity( bestCaptainChair );
}

/*
=====================
idAI::Event_SitDownInCaptainChair
=====================
*/
void idAI::Event_SitDownInCaptainChair( idEntity *ent ) {
	seated_in_captain_chair = true;
	if ( ent ) {
		...
		GetPhysics()->SetOrigin( ent->GetPhysics()->GetOrigin() );
		//SetDeltaViewAngles( ent->spawnArgs.GetMatrix("rotation", "1 0 0 0 1 0 0 0 1").ToAngles() ); // ok
		TurnToward( ent->GetPhysics()->GetOrigin() + ( ent->spawnArgs.GetMatrix("rotation", "1 0 0 0 1 0 0 0 1").ToAngles().ToForward() * 40 ) ); // better
		// BOYETTE NOTE TODO: maybe make this skin a spawnarg with this as the default
		//this->SetSkin( declManager->FindSkin("skins/models/space_command/crewmembers/hide_weapons") ); // this is handled in the script now and is not necessary here
		sitting_animation_name = ent->spawnArgs.GetString( "sitting_anim_name", "default_captain_chair_sitting");
		if ( ent->IsType(sbCaptainChair::Type) ) {
			static_cast<sbCaptainChair*>( ent )->SeatedEntity = this;
			if ( static_cast<sbCaptainChair*>( ent )->ParentShip ) {
				static_cast<sbCaptainChair*>( ent )->ParentShip->RecalculateAllModuleEfficiencies();
			}
		}
	}
}
...
/*
=====================
idAI::Event_StandUpFromCaptainChair
=====================
*/
void idAI::Event_StandUpFromCaptainChair( idEntity *ent ) {
	seated_in_captain_chair = false;
	if ( ent ) {
		float stand_up_distance = ent->spawnArgs.GetFloat("stand_up_distance","50");

		sbCaptainChair* captainchair_cast;
		if ( ent->IsType(sbCaptainChair::Type) ) {
			captainchair_cast = dynamic_cast<sbCaptainChair*>( ent );
		}
		if ( captainchair_cast->ParentShip && ShipOnBoard && captainchair_cast->ParentShip == ShipOnBoard ) { // this is so if they get accidentally transported to another ship, they won't get their origin point set back to their captain chair they were sitting in - unfortunately they will still play the sitting animation until something happens on the new ship.
			SetOrigin( ent->GetPhysics()->GetOrigin() + ( ent->spawnArgs.GetMatrix("rotation", "1 0 0 0 1 0 0 0 1").ToAngles().ToForward() * stand_up_distance ) ); // PERFECT - if 50 is not enough we can always increase and if necessary make a spawnarg so it can vary.
			GetPhysics()->SetOrigin( ent->GetPhysics()->GetOrigin() + ( ent->spawnArgs.GetMatrix("rotation", "1 0 0 0 1 0 0 0 1").ToAngles().ToForward() * stand_up_distance ) ); // PERFECT - if 50 is not enough we can always increase and if necessary make a spawnarg so it can vary.
		}
		physicsObj.SetClipMask( MASK_MONSTERSOLID );
		disableGravity = false;
		// BOYETTE NOTE TODO: maybe make this skin a spawnarg with this as the default
		//this->SetSkin( declManager->FindSkin("skins/models/space_command/crewmembers/show_weapons") ); // this is handled in the script now and is not necessary here
		//this->SetSkin( declManager->FindSkin( spawnArgs.GetString( "skin", this->animator.ModelDef()->GetDefaultSkin()->GetName() ) ) ); // this is handled in the script now and is not necessary here
		sitting_animation_name = NULL;
		if ( ent->IsType(sbCaptainChair::Type) ) {
			static_cast<sbCaptainChair*>( ent )->SeatedEntity = NULL;
			if ( static_cast<sbCaptainChair*>( ent )->ParentShip ) {
				static_cast<sbCaptainChair*>( ent )->ParentShip->RecalculateAllModuleEfficiencies();
			}
		}
...
/*
=====================
idAI::Event_IsSeatedInCaptainChair
=====================
*/
void idAI::Event_IsSeatedInCaptainChair( void ) {
	if ( seated_in_captain_chair ) {
		idThread::ReturnInt( true );
	} else {
		idThread::ReturnInt( false );
	}
...
/*
=====================
idAI::Event_StartWorkingOnConsole
=====================
*/
void idAI::Event_StartWorkingOnConsole( idEntity *ent ) {
	working_on_console = true;
	if ( ent ) {

		physicsObj.SetClipMask( 0 );
		// BOYETTE BEGIN: added 05 21 2016 - so the box doesn't get in the way for the player or anyone else
		physicsObj.SetContents( 0 );
		physicsObj.GetClipModel()->Unlink();
		// BOYETTE END
		disableGravity = true;
		...
		//SetDeltaViewAngles( ent->spawnArgs.GetMatrix("rotation", "1 0 0 0 1 0 0 0 1").ToAngles() ); // ok
		TurnToward( ent->GetPhysics()->GetOrigin() + ( ent->spawnArgs.GetMatrix("rotation", "1 0 0 0 1 0 0 0 1").ToAngles().ToForward() * 40 ) ); // better
		// BOYETTE NOTE TODO: maybe make this skin a spawnarg with this as the default - could call the spawnarg "hide_weapons_skin"
		hide_weapons_skin_active = true;
		this->SetSkin( declManager->FindSkin("skins/models/space_command/crewmembers/hide_weapons") );

		Event_HideDefAttach();

		sitting_animation_name = ent->spawnArgs.GetString( "sitting_anim_name", "idle");
		//if ( sitting_animation_name ) {
		//	gameLocal.Printf( "Sitting Animation Found: " + sitting_animation_name + "\n" );
		//}
		if ( ent->IsType( sbConsole::Type ) ) {
			dynamic_cast<sbConsole*>( ent )->console_occupied = true;
		}
	}
}
...
/*
=====================
idAI::Event_StopWorkingOnConsole
=====================
*/
// BOYETTE NOTE: PLAYER: the captain chair and the console use different methods to make it look like the player is sitting down. the captain chair uses it's origin as the view position of the player. the console uses some adjustors to do this.
// BOYETTE NOTE: AIs: the captain chair and the console use different methods to make it look like the AI is sitting down. the captain chair transports the AI to it's origin when the ai sits down - and transports it some distance in fron of or behind when it stand up.
// BOYETTE NOTE: the console on the other hand always keeps the AI's origin the same (except for this -2 thing we just added below). It is up to the animator to make sure that the AI body is animated some distance in front of or behind it's origin.
// BOYETTE NOTE: when the AI does stand up from the console, the AI simply exits it's animation and is unbound from the console so it can move around normally again.
// BOYETTE NOTE TODO: we might want to decide on which way is better - or if it matters which one - and make them both the same.
void idAI::Event_StopWorkingOnConsole( idEntity *ent ) {
	working_on_console = false;
	if ( ent ) {

		sbConsole* console_cast;
		if ( ent->IsType(sbConsole::Type) ) {
			console_cast = dynamic_cast<sbConsole*>( ent );
		}
		if ( console_cast->ParentShip && ShipOnBoard && console_cast->ParentShip == ShipOnBoard ) { // this is so if they get accidentally transported to another ship, they won't get their origin point set back to their console they were working on - unfortunately they will still play the working animation until something happens on the new ship.
			// BOYETTE NOTE: before 05 26 2016: SetOrigin( ent->GetPhysics()->GetOrigin() + ( ent->spawnArgs.GetMatrix("rotation", "1 0 0 0 1 0 0 0 1").ToAngles().ToForward() * -2.0f ) ); // Might want t o make a spawnarg here - The -2 is just to help ensure that this AI doesn't end up inside other entities since they are all trygin to get to the origin.
			// BOYETTE NOTE: before 05 26 2016: GetPhysics()->SetOrigin( ent->GetPhysics()->GetOrigin() + ( ent->spawnArgs.GetMatrix("rotation", "1 0 0 0 1 0 0 0 1").ToAngles().ToForward() * -2.0f ) ); // Might want t o make a spawnarg here - The -2 is just to help ensure that this AI doesn't end up inside other entities since they are all trygin to get to the origin.
			idVec3 random_offset_vec = idVec3(gameLocal.random.CRandomFloat(),gameLocal.random.CRandomFloat(),0); // this to help prevent AI's from getting stuck inside each other as the console's original is a popular point.
			SetOrigin( ent->GetPhysics()->GetOrigin() + random_offset_vec );
			GetPhysics()->SetOrigin( ent->GetPhysics()->GetOrigin() + random_offset_vec );
		}
		physicsObj.SetClipMask( MASK_MONSTERSOLID );
		// BOYETTE BEGIN: added 05 21 2016 - re-enable the box that we disabled when starting working
		physicsObj.EnableClip();
		if ( spawnArgs.GetBool( "big_monster" ) ) {
			physicsObj.SetContents( 0 );
		} else if ( use_combat_bbox ) {
		...
		// BOYETTE END
		disableGravity = false;
		//this->SetSkin( declManager->FindSkin("skins/models/space_command/crewmembers/show_weapons") );

		/*
		if ( DefAttach.GetEntity() ) {
			DefAttach.GetEntity()->Show();
		}
		*/
		hide_weapons_skin_active = false;
		const char * skinName;
		skinName = spawnArgs.GetString( "skin", ""  );
		if ( skinName[0] ) {
			SetSkin( declManager->FindSkin( skinName ) );
		} else if ( animator.ModelDef() && animator.ModelDef()->GetDefaultSkin() && animator.ModelDef()->GetDefaultSkin()->GetName()[0] ) {
			SetSkin( declManager->FindSkin( spawnArgs.GetString( "skin", animator.ModelDef()->GetDefaultSkin()->GetName() ) ) );
		} else {
			SetSkin( declManager->FindSkin("skins/models/space_command/crewmembers/show_weapons") );
		}
		sitting_animation_name = NULL;
		if ( ent->IsType( sbConsole::Type ) ) {
			dynamic_cast<sbConsole*>( ent )->console_occupied = false;
		}
	}
}
...
/*
=====================
idAI::Event_IsWorkingOnConsole
=====================
*/
void idAI::Event_IsWorkingOnConsole( void ) {
	if ( working_on_console ) {
		idThread::ReturnInt( true );
	} else {
		idThread::ReturnInt( false );
	}
...
/*
=====================
idAI::Event_ActivateHideWeaponSkin
=====================
*/
void idAI::Event_ActivateHideWeaponSkin( void ) {
	// BOYETTE NOTE TODO: maybe make this skin a spawnarg with this as the default - could call the spawnarg "hide_weapons_skin"
	hide_weapons_skin_active = true;
	SetSkin( declManager->FindSkin("skins/models/space_command/crewmembers/hide_weapons") );
}

/*
=====================
idAI::Event_DeactivateHideWeaponSkin
=====================
*/
void idAI::Event_DeactivateHideWeaponSkin( void ) {
	hide_weapons_skin_active = false;
	const char * skinName;
	skinName = spawnArgs.GetString( "skin", ""  );
	if ( skinName[0] ) {
...
/*
=====================
idAI::Event_IsHideWeaponSkinActive
=====================
*/
void idAI::Event_IsHideWeaponSkinActive( void ) {
	if ( hide_weapons_skin_active ) {
		idThread::ReturnInt( true );
	} else {
		idThread::ReturnInt( false );
	}
...
/*
================
idAI::Event_GetSittingAnimName
================
*/
void idAI::Event_GetSittingAnimName( void ) {
	idThread::ReturnString( sitting_animation_name.c_str() );
}

void idAI::Event_HideDefAttach( void ) {
	if ( DefAttach.GetEntity() ) {
		DefAttach.GetEntity()->Hide();
		if ( DefAttach.GetEntity()->GetPhysics() ) {
			DefAttach.GetEntity()->GetPhysics()->SetContents(0); // set non-solid
		}
		// BOYETTE NOTE TODO: this could be useful for preventing traffic jams - dynamic clip box sizes
		/*
		idVec3 temp = GetPhysics()->GetOrigin();
		...
		if ( spawnArgs.GetVector( "size", NULL, size ) ) {
			...
			GetPhysics()->SetClipBox( idBounds( idVec3( size.x * -0.5f, size.y * -0.5f, 0.0f ), idVec3( size.x * 0.5f, size.y * 0.5f, size.z ) ), 1.0f );

			// the origin of the new clip model gets temporarily set to 0,0,0 on the map - this prevents that. we don't want our physics object's current origin value to get reset to 0 temporarily. See the SetClipModel function on idPlayer as the original example.
			GetPhysics()->GetClipModel()->Translate(temp);
		}
		*/
	}
}

void idAI::Event_ShowDefAttach( void ) {
	if ( DefAttach.GetEntity() ) {
		DefAttach.GetEntity()->Show();
		if ( DefAttach.GetEntity()->GetPhysics() ) {
			if ( g_allowPlayerToPushMonsters.GetBool() ) {
				DefAttach.GetEntity()->GetPhysics()->SetContents(0); // set non-solid
			} else {
				DefAttach.GetEntity()->GetPhysics()->SetContents(CONTENTS_SOLID); // set solid
			}
		}
		// BOYETTE NOTE TODO: this could be useful for preventing traffic jams - dynamic clip box sizes
		/*
		...
		idVec3 size;
		if ( spawnArgs.GetVector( "show_def_attach_size", NULL, size ) ) {
			if ( ( size.x < 0.0f ) || ( size.y < 0.0f ) || ( size.z < 0.0f ) ) {
				gameLocal.Error( "Invalid show_def_attach_size '%s' on entity '%s'", size.ToString(), name.c_str() );
			}
			GetPhysics()->SetClipBox( idBounds( idVec3( size.x * -0.5f, size.y * -0.5f, 0.0f ), idVec3( size.x * 0.5f, size.y * 0.5f, size.z ) ), 1.0f );
...
void idAI::Event_IsDefAttachHidden( void ) {
	if ( DefAttach.GetEntity() ) {
		if ( DefAttach.GetEntity()->IsHidden() ) {
			idThread::ReturnInt( true );
		} else {
			idThread::ReturnInt( false );
		}
...
/*
=====================
idAI::Event_MoveCloseToEntity
=====================
*/
void idAI::Event_MoveCloseToEntity( idEntity *ent ) {
	StopMove( MOVE_STATUS_DEST_NOT_FOUND );
	if ( ent ) {
		MoveCloseToEntity( ent );
	}
}

/*
=====================
idAI::Event_FoodProjectileRange
=====================
*/
/* enable this code with caution - it might have screwed up your computer - possibly because foodprojectile doesn't exist right now
void idAI::Event_FoodProjectileRange( void ) {
	float dist;
	idProjectile *enemyFoodProjectile = foodprojectile.GetEntity();

	if ( enemyFoodProjectile ) {
		dist = ( enemyFoodProjectile->GetPhysics()->GetOrigin() - GetPhysics()->GetOrigin() ).Length();
	} else {
		// Just some really high number
		dist = idMath::INFINITY;
	}
...
/*
=====================
idAI::Event_FoodProjectileRange2D
=====================
*/
/* enable this code with caution - it might have screwed up your computer - possibly because foodprojectile doesn't exist right now
void idAI::Event_FoodProjectileRange2D( void ) {
	float dist;
	idProjectile *enemyFoodProjectile = foodprojectile.GetEntity();

	if ( enemyFoodProjectile ) {
		dist = ( enemyFoodProjectile->GetPhysics()->GetOrigin().ToVec2() - GetPhysics()->GetOrigin().ToVec2() ).Length();
	} else {
		// Just some really high number
		dist = idMath::INFINITY;
	}
...
/*
=====================
idAI::Event_DistanceToEntity
=====================
*/
void idAI::Event_DistanceToEntity( idEntity *ent ) {
	float dist;

	if ( ent ) {
		dist = ( ent->GetPhysics()->GetOrigin() - GetPhysics()->GetOrigin() ).Length();
	} else {
		// Just some really high number
		dist = idMath::INFINITY;
	}
...
/*
=====================
idAI::Event_DistanceToEntity2D
=====================
*/
void idAI::Event_DistanceToEntity2D( idEntity *ent ) {
	float dist;

	if ( ent ) {
		dist = ( ent->GetPhysics()->GetOrigin().ToVec2() - GetPhysics()->GetOrigin().ToVec2() ).Length();
	} else {
		// Just some really high number
		dist = idMath::INFINITY;
	}
...
// boyette AI move command begin
void idAI::Event_ReturnEntityCommandedToMoveTo( void ) {
	if ( EntityCommandedToMoveTo ) {
		idThread::ReturnEntity( EntityCommandedToMoveTo );
	} else {
		idThread::ReturnEntity( NULL );
	}
}
void idAI::Event_ClearEntityToMoveToByCommand( void ) {
	EntityCommandedToMoveTo = NULL;
}

void idAI::Event_ReturnEnemyDoorToAttack( void ) {
	if ( EnemyDoorToAttack ) {
		idThread::ReturnEntity( EnemyDoorToAttack );
	} else {
		idThread::ReturnEntity( NULL );
	}
}
void idAI::Event_ClearEnemyDoorToAttack( void ) {
	EnemyDoorToAttack = NULL;
}
// boyette AI move command end

// boyette ship command begin

/*
=====================
idAI::Event_FindNearestShipConsole
=====================
*/
void idAI::Event_FindNearestShipConsole( int useFOV ) {
	idEntity	*ent;
	sbConsole	*console;
	sbConsole	*bestConsole;
	float		bestDist;
	float		dist;
	idVec3		delta;
	pvsHandle_t pvs;
	...
	bestConsole = NULL;
	if ( ShipOnBoard ) {
		//gameLocal.Printf( "FINDING SHIP CONSOLE.\n" );
		for ( int i = 0; i < MAX_MODULES_ON_SHIPS; ++i ) {
			if ( ShipOnBoard->consoles[i] ) {

				if ( !gameLocal.pvs.InCurrentPVS( pvs, ShipOnBoard->consoles[i]->GetPVSAreas(), ShipOnBoard->consoles[i]->GetNumPVSAreas() ) ) {
					continue;
				}

				delta = physicsObj.GetOrigin() - ShipOnBoard->consoles[i]->GetPhysics()->GetOrigin();
				dist = delta.LengthSqr();
				if ( ( dist < bestDist ) && CanSee( ShipOnBoard->consoles[i], useFOV != 0 ) ) {
					bestDist = dist;
					bestConsole = ShipOnBoard->consoles[i];
				}
			}
		}
	} else {
		for ( ent = gameLocal.spawnedEntities.Next(); ent != NULL; ent = ent->spawnNode.Next() ) {
			...
			console = static_cast<sbConsole *>( ent );


			if ( !gameLocal.pvs.InCurrentPVS( pvs, console->GetPVSAreas(), console->GetNumPVSAreas() ) ) {
				continue;
			}

			delta = physicsObj.GetOrigin() - console->GetPhysics()->GetOrigin();
			dist = delta.LengthSqr();
			if ( ( dist < bestDist ) && CanSee( console, useFOV != 0 ) ) {
				bestDist = dist;
				bestConsole = console;
			}
		}
	...
	gameLocal.pvs.FreeCurrentPVS( pvs );
	idThread::ReturnEntity( bestConsole );
}

/*
=====================
idAI::Event_FindNearestShipModule
=====================
*/
void idAI::Event_FindNearestShipModule( int useFOV ) {
	idEntity	*ent;
	sbModule	*module;
	sbModule	*bestModule;
	float		bestDist;
	...
	bestModule = NULL;
	if ( ShipOnBoard ) {
		//gameLocal.Printf( "FINDING SHIP MODULE.\n" );
		for ( int i = 0; i < MAX_MODULES_ON_SHIPS; ++i ) {
			if ( ShipOnBoard->consoles[i] && ShipOnBoard->consoles[i]->ControlledModule ) {

				if ( !gameLocal.pvs.InCurrentPVS( pvs, ShipOnBoard->consoles[i]->ControlledModule->GetPVSAreas(), ShipOnBoard->consoles[i]->ControlledModule->GetNumPVSAreas() ) ) {
					continue;
				}

				delta = physicsObj.GetOrigin() - ShipOnBoard->consoles[i]->ControlledModule->GetPhysics()->GetOrigin();
				dist = delta.LengthSqr();
				if ( ( dist < bestDist ) && CanSee( ShipOnBoard->consoles[i]->ControlledModule, useFOV != 0 ) ) {
					bestDist = dist;
					bestModule = ShipOnBoard->consoles[i]->ControlledModule;
				}
			}
		}
	} else {
		for ( ent = gameLocal.spawnedEntities.Next(); ent != NULL; ent = ent->spawnNode.Next() ) {
			if ( !ent->IsType( sbModule::Type ) ) {
				continue;
			}

			module = static_cast<sbModule *>( ent );


			if ( !gameLocal.pvs.InCurrentPVS( pvs, module->GetPVSAreas(), module->GetNumPVSAreas() ) ) {
				continue;
			}

			delta = physicsObj.GetOrigin() - module->GetPhysics()->GetOrigin();
			dist = delta.LengthSqr();
			if ( ( dist < bestDist ) && CanSee( module, useFOV != 0 ) ) {
				bestDist = dist;
				bestModule = module;
			}
		}
	...
	gameLocal.pvs.FreeCurrentPVS( pvs );
	idThread::ReturnEntity( bestModule );
}

/*
=====================
idAI::Event_GetEntityHealth
=====================
*/
void idAI::Event_GetEntityHealth( idEntity* ent ) { // boyette note for future - still need to figure out the best way to do this.
	if (ent) {
		idThread::ReturnFloat( ent->health );
	} else {
		idThread::ReturnFloat( 10000 );
	}
}

/*
=====================
idAI::Event_GetEntityMaxhealth
=====================
*/
void idAI::Event_GetEntityMaxHealth( idEntity* ent ) { // boyette note for future - still need to figure out the best way to do this.
	if (ent) {
		idThread::ReturnFloat( ent->entity_max_health );
	} else {
		idThread::ReturnFloat( 10000 );
	}
}
...
/*
=====================
idAI::Event_IsFriendly
=====================
*/
/*
void idAI::Event_IsFriendly( idEntity* ent ) {
	int isfriendly = false;
	if( ent->team == team ) {
		isfriendly = true;
	}
	idThread::ReturnInt( isfriendly );
}
*/
// boyette note - This function didn't work initially because the int team variable was not initialized on idEntity. Old note - this function needs to be fixed - it can't tell if something is an enemy.
void idAI::Event_IsFriendly( idEntity* ent ) {
	if( ent ) {
		if( ent->team == team ) {
			idThread::ReturnInt( true );
...
/*
=====================
idAI::Event_ConsolesModuleIsBuffed
=====================
*/
void idAI::Event_ConsolesModuleIsBuffed( idEntity* ent ) {
	int isbuffedconsolesmodule = 0;
	if ( ent ) {
		if ( ent->IsType(sbConsole::Type) ) {
			sbConsole* console;
			console = static_cast<sbConsole *>( ent );
			if (console->ControlledModule) {
				if ( console->ControlledModule->module_buffed_amount > 0 ) {
					idThread::ReturnInt( true );
				} else {
					idThread::ReturnInt( false );
				}
...
/*
=====================
idAI::Event_BuffConsolesModule // right now this function needs to be called, at the least, every 2 seconds to maintain continuous buffing of a module. So don't do system.waits greater than two seconds when using this function.
=====================
*/
void idAI::Event_BuffConsolesModule( idEntity* ent ) {
	if ( ent->IsType(sbConsole::Type) ) {
		sbConsole* console;
		console = static_cast<sbConsole *>( ent );
		if (console->ControlledModule) {
			console->ControlledModule->BuffModule(module_buff_amount); // later on you can grab the buff amount from the idAI's spawn arg on it's def.
/*
	// to create the beam
	if ( module_console_beam_active == false ) {
		if ( DefAttach.GetEntity() ) {
			ModuleConsoleBeam.renderEntity.origin = DefAttach.GetEntity()->GetPhysics()->GetOrigin(); // if they have a tricorder
		} else {
			ModuleConsoleBeam.renderEntity.origin = GetPhysics()->GetOrigin(); // can change this to the def_attach origin
		}
		ModuleConsoleBeam.renderEntity.axis = GetPhysics()->GetAxis();
		ModuleConsoleBeam.renderEntity.shaderParms[ SHADERPARM_BEAM_WIDTH ] = 24.0f;
		ModuleConsoleBeam.renderEntity.shaderParms[ SHADERPARM_RED ] = 1.0f;
		ModuleConsoleBeam.renderEntity.shaderParms[ SHADERPARM_GREEN ] = 1.0f;
		ModuleConsoleBeam.renderEntity.shaderParms[ SHADERPARM_BLUE ] = 1.0f;
		ModuleConsoleBeam.renderEntity.shaderParms[ SHADERPARM_ALPHA ] = 1.0f;
		ModuleConsoleBeam.renderEntity.shaderParms[ SHADERPARM_DIVERSITY] = gameLocal.random.CRandomFloat() * 0.75;
		ModuleConsoleBeam.renderEntity.hModel = renderModelManager->FindModel( "_beam" );
		ModuleConsoleBeam.renderEntity.callback = NULL;
		ModuleConsoleBeam.renderEntity.numJoints = 0;
		ModuleConsoleBeam.renderEntity.joints = NULL;
		ModuleConsoleBeam.renderEntity.bounds.Clear();
		ModuleConsoleBeam.renderEntity.customSkin = declManager->FindSkin( "skins/duffybolt" );
		ModuleConsoleBeam.modelDefHandle = gameRenderWorld->AddEntityDef( &ModuleConsoleBeam.renderEntity );
		module_console_beam_active = true;
		// to set the target of the beam
		ModuleConsoleBeam.target = console->ControlledModule;//put module origin plus some height above the origin so the beam is not going into the ground.
	} else {
		// to remove the beam
		module_console_beam_active = false;
		gameRenderWorld->FreeEntityDef( ModuleConsoleBeam.modelDefHandle );
		ModuleConsoleBeam.modelDefHandle = -1;
		UpdateVisuals();
	}
*/
...
/*
=====================
idAI::Event_CreateBeamToEnt
=====================
*/
void idAI::Event_CreateBeamToEnt( idEntity* ent ) {
	if ( ent ) {
		// to create the beam
		if ( module_console_beam_active == false ) {
			memset( &ModuleConsoleBeam.renderEntity, 0, sizeof( renderEntity_t ) );
			if ( DefAttach.GetEntity() && DefAttach.GetEntity()->GetPhysics() ) {
				ModuleConsoleBeam.renderEntity.origin = DefAttach.GetEntity()->GetPhysics()->GetOrigin(); // if they have a tricorder
			} else {
				if ( GetPhysics() ) {
					ModuleConsoleBeam.renderEntity.origin = GetPhysics()->GetOrigin(); // can change this to the def_attach origin
			...
			ModuleConsoleBeam.renderEntity.axis = GetPhysics()->GetAxis();
			ModuleConsoleBeam.renderEntity.shaderParms[ SHADERPARM_BEAM_WIDTH ] = spawnArgs.GetFloat( "beam_width", "24.0" );
			ModuleConsoleBeam.renderEntity.shaderParms[ SHADERPARM_RED ] = 1.0f;
			ModuleConsoleBeam.renderEntity.shaderParms[ SHADERPARM_GREEN ] = 1.0f;
			ModuleConsoleBeam.renderEntity.shaderParms[ SHADERPARM_BLUE ] = 1.0f;
			ModuleConsoleBeam.renderEntity.shaderParms[ SHADERPARM_ALPHA ] = 1.0f;
			...
			ModuleConsoleBeam.renderEntity.bounds.Clear();
			if ( ent->team == team ) {
				ModuleConsoleBeam.renderEntity.customSkin = declManager->FindSkin( spawnArgs.GetString( "friendly_beam_skin", "skins/space_command/friendly_beam_default") );
				...
				ModuleConsoleBeam.renderEntity.customSkin = declManager->FindSkin( spawnArgs.GetString( "hostile_beam_skin", "skins/space_command/hostile_beam_default") );
			...
			module_console_beam_active = true;
			// to set the target of the beam
			ModuleConsoleBeam.target = ent;//put module origin plus some height above the origin so the beam is not going into the ground.
		}
	}
}
...
/*
=====================
idAI::Event_RemoveBeamToEnt
=====================
*/
void idAI::Event_RemoveBeamToEnt( void ) {
	// to remove the beam
	if ( module_console_beam_active ) {
		module_console_beam_active = false;
		gameRenderWorld->FreeEntityDef( ModuleConsoleBeam.modelDefHandle );
		ModuleConsoleBeam.modelDefHandle = -1;
		StopSound(SND_CHANNEL_WEAPON,false);
		UpdateVisuals();
		ModuleConsoleBeam.target = NULL;
	}
}

/*
=====================
idAI::Event_ReturnModuleConsoleDamageDefName
=====================
*/
void idAI::Event_ReturnModuleConsoleDamageDefName( void ) {
	idThread::ReturnString(module_console_damage_def_name);
}
/*
=====================
idAI::Event_ReturnModuleConsoleRepairDefName
=====================
*/
void idAI::Event_ReturnModuleConsoleRepairDefName( void ) {
	idThread::ReturnString(module_console_repair_def_name);
}
/*
=====================
idAI::Event_ReturnDoorDamageDefName
=====================
*/
void idAI::Event_ReturnDoorDamageDefName( void ) {
	idThread::ReturnString(door_damage_def_name);
}

/*
=====================
idAI::Event_ShipOnBoardIsAtRedAlert
=====================
*/
void idAI::Event_ShipOnBoardIsAtRedAlert( void ) {
	if ( ShipOnBoard && ShipOnBoard->red_alert ) {
		idThread::ReturnInt( true );
	} else {
		idThread::ReturnInt( false );
	}
...
/*
================
idAI::Event_UpdateCrewAutoModeBehavior
================
*/
void idAI::Event_UpdateCrewAutoModeBehavior( void ) {
	if ( crew_auto_mode_activated && !EntityCommandedToMoveTo ) {
		idEntity*	auto_move_ent = NULL;
		idEntity*	nearest_auto_move_ent = NULL;
		if ( ShipOnBoard && ShipOnBoard->team == team || ShipOnBoard->HasNeutralityWithAI(this) ) {
			if ( player_follow_mode_activated && gameLocal.GetLocalPlayer() && gameLocal.GetLocalPlayer()->ShipOnBoard && gameLocal.GetLocalPlayer()->ShipOnBoard == ShipOnBoard ) { // BOYETTE TODO: do this above too on friendly ships
				auto_move_ent = ReturnNearestRoomNodeToThePlayer();
				nearest_auto_move_ent = ReturnNearestRoomNode();
			} else {
				auto_move_ent = ReturnNearestDamagedShipModule();
				nearest_auto_move_ent = ReturnNearestShipModule();
			}

			if ( auto_move_ent && CanSee(auto_move_ent,false) && nearest_auto_move_ent && nearest_auto_move_ent == auto_move_ent && CanSee(nearest_auto_move_ent,false) ) { // TODO: need to make a non event version of this function
				return;
			} else if ( auto_move_ent ) {
				SetEntityToMoveToByCommand(auto_move_ent);
			}
		} else if ( ShipOnBoard && ShipOnBoard->team != team ) {

			if ( player_follow_mode_activated && gameLocal.GetLocalPlayer() && gameLocal.GetLocalPlayer()->ShipOnBoard && gameLocal.GetLocalPlayer()->ShipOnBoard == ShipOnBoard ) { // BOYETTE TODO: do this above too on friendly ships
				auto_move_ent = ReturnNearestRoomNodeToThePlayer();
				nearest_auto_move_ent = ReturnNearestRoomNode();
			} else {
				if ( ParentShip && ParentShip->boarders_should_target_player && gameLocal.GetLocalPlayer() && gameLocal.GetLocalPlayer()->ShipOnBoard && gameLocal.GetLocalPlayer()->ShipOnBoard == ShipOnBoard ) { // 50% - determined in ship AI function for successful transport
					auto_move_ent = ReturnNearestRoomNodeToThePlayer();
					nearest_auto_move_ent = ReturnNearestRoomNode();
				} else if ( ParentShip && ParentShip->boarders_should_target_random_module && ShipOnBoard->consoles[ParentShip->boarders_should_target_module_id] && ShipOnBoard->consoles[ParentShip->boarders_should_target_module_id]->ControlledModule && ShipOnBoard->consoles[ParentShip->boarders_should_target_module_id]->ControlledModule->health > 0 ) { // 25% - determined in ship AI function for successful transport
					auto_move_ent = ShipOnBoard->consoles[ParentShip->boarders_should_target_module_id]->ControlledModule;
					nearest_auto_move_ent = ReturnNearestShipModule();
				} else { // 25% - determined in ship AI function for successful transport
					auto_move_ent = ReturnNearestUnDisabledShipModule();
					nearest_auto_move_ent = ReturnNearestShipModule();
				}
			}

			if ( auto_move_ent && CanSee(auto_move_ent,false) && nearest_auto_move_ent && nearest_auto_move_ent == auto_move_ent && CanSee(nearest_auto_move_ent,false) ) {
				return;
			} else if ( auto_move_ent ) {
				SetEntityToMoveToByCommand(auto_move_ent);
			}
...
/*
=====================
idAI::Event_IsMyCaptainChair
=====================
*/
void idAI::Event_IsMyCaptainChair( idEntity* ent ) {
	int isthismycaptainchair = 0;
	if ( ent ) {
		if ( ent->IsType(sbCaptainChair::Type) ) {
			sbCaptainChair* captainchair;
			captainchair = static_cast<sbCaptainChair *>( ent );
			if ( !captainchair->SeatedEntity.GetEntity() && captainchair->ParentShip && captainchair->ParentShip->crew[CAPTAINCREWID] && captainchair->ParentShip->crew[CAPTAINCREWID] == this ) {
				idThread::ReturnInt( true );
			} else {
				idThread::ReturnInt( false );
			}
...
/*
=====================
idAI::Event_FaceForwardOfEntity
=====================
*/
void idAI::Event_FaceForwardOfEntity( idEntity *ent ) {
	/*
	if ( !ent ) {
		StopMove( MOVE_STATUS_DEST_NOT_FOUND );
		return;
	...
	*/
	if ( ent ) {
		TurnToward( ent->GetPhysics()->GetOrigin() + ( ent->spawnArgs.GetMatrix("rotation", "1 0 0 0 1 0 0 0 1").ToAngles().ToForward() * 40.0f ) );
	}
	/*
	move.goalEntity		= ent;
...
/*
=====================
idAI::Event_FaceAbsoluteCenterOfEntity
=====================
*/
void idAI::Event_FaceAbsoluteCenterOfEntity( idEntity *ent ) {
	if ( ent ) {
		TurnToward( ent->GetPhysics()->GetAbsBounds().GetCenter() );
	}
	return;
}
...
/*
================
idAI::Event_BeginAIDialogueWithPlayer
================
*/
void idAI::Event_BeginAIDialogueWithPlayer( void ) {
	if ( gameLocal.GetLocalPlayer() && gameLocal.GetLocalPlayer()->DialogueAI != this ) {
		gameLocal.GetLocalPlayer()->SetOverlayAIDialogeGui();
	}
}
/*
================
idAI::Event_EndAIDialogueWithPlayer
================
*/
void idAI::Event_EndAIDialogueWithPlayer( void ) {
	if ( gameLocal.GetLocalPlayer() && gameLocal.GetLocalPlayer()->DialogueAI && gameLocal.GetLocalPlayer()->DialogueAI == this ) {
		gameLocal.GetLocalPlayer()->CloseOverlayAIDialogeGui();
	}
}
/*
=====================
idAI::Event_UsesSpaceCommandDialogueBehavior
=====================
*/
void idAI::Event_UsesSpaceCommandDialogueBehavior( void ) {
	if ( uses_space_command_dialogue_behavior ) {
		idThread::ReturnInt( true );
	} else {
		idThread::ReturnInt( false );
	}
...
/*
=====================
idAI::Event_InAIDialogueWithPlayer
=====================
*/
void idAI::Event_InAIDialogueWithPlayer( void ) {
	if ( currently_in_dialogue_with_player ) {
		idThread::ReturnInt( true );
	} else {
		idThread::ReturnInt( false );
	}
...
/*
================
idAI::Event_ReturnAIDialogueAnimToPlay
================
*/
void idAI::Event_ReturnAIDialogueAnimToPlay( void ) {
	if ( ai_dialogue_anim_to_play ) {
		idThread::ReturnString( ai_dialogue_anim_to_play );
	} else {
...
/*
================
idAI::Event_ClearAIDialogueAnimToPlay
================
*/
void idAI::Event_ClearAIDialogueAnimToPlay( void ) {
	ai_dialogue_anim_to_play = "";
}
...
=====================
*/
void idAI::Event_WaitingUntilPlayerTalksToMe( void ) {
	/*
	if ( waiting_until_player_talks_to_me ) {
		idThread::ReturnInt( true );
	} else {
		idThread::ReturnInt( false );
	}
	*/
	idThread::ReturnInt( waiting_until_player_talks_to_me );
}

// boyette ship command end
