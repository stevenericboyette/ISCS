...
typedef union __declspec(intrin_type) _CRT_ALIGN(16) __m128c { // BOYETTE NOTE IMPROTANT: ccpcheck considers this a systax error and cannot analyze the rest of the source becuase of it. Change it to "typedef union __declspec(intrin_type) __declspec(align(16)) __m128c {" temporarily when using cppcheck for static analysis
				__m128c() {}
