...
public:
	...
	// BOYETTE WEIRD FIX BEGIN - added 10/09/2016
	// Sets the impulse to IMPULSE_41 so we can close the captain menu using IMPULSE_41 even when we didn't use IMPULSE_41 to open the captain menu
	void			WeirdFix( void );
	// BOYETTE WEIRD FIX END
...
/*
================
idUsercmdGenLocal::WeirdFix
================
*/
void idUsercmdGenLocal::WeirdFix( void ) {
	impulse = IMPULSE_41;
}
// BOYETTE WEIRD FIX END