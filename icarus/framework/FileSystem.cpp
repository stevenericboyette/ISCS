...
static pureExclusion_t pureExclusions[] = {
	...
	{ 0,	0,	"sound/sounds_used_in_source/VO",										".ogg",		excludePathPrefixAndExtension },
	{ 0,	0,	"sound/sounds_used_in_source/VO",										".wav",		excludePathPrefixAndExtension },
#if	defined DOOM3_PURE_SPECIAL_CASES	
	// add any special-case files or paths for pure servers here
	{ 0,	0,	"sound/sounds_used_in_source/vo_intro_cutscene_test1.wav",		NULL,		excludeFullName },
	{ 0,	0,	"sound/space_command_sounds/weapons/creepy_weapon/energize_01.wav",		NULL,		excludeFullName },
	{ 0,	0,	"sound/sounds_used_in_source/creepy/vocal_fx",					".ogg",		excludePathPrefixAndExtension },
	{ 0,	0,	"sound/sounds_used_in_source/creepy/vocal_fx",					".wav",		excludePathPrefixAndExtension },
	{ 0,	0,	"sound/sounds_used_in_source/feedback",								".ogg",		excludePathPrefixAndExtension },
	{ 0,	0,	"sound/sounds_used_in_source/feedback",								".wav",		excludePathPrefixAndExtension },
	{ 0,	0,	"textures/images_used_in_source/noexist.tga",	NULL,		excludeFullName }, // BOYETTE NOTE: was originally "guis/assets/mainmenu/chnote.tga". This image never existed. Not sure why they put that here. Changed to "textures/images_used_in_source/noexist.tga"
	{ 0,	0,	"sound/sounds_used_in_source/creepy/vocal_fx/creepy_vo.wav",	NULL,		excludeFullName },
	{ 0,	0,	"textures/images_used_in_source/console_fonts/console_font.tga",						NULL,		excludeFullName },
	{ 0,	0,	"dds/textures/images_used_in_source/console_fonts/console_font.dds",					NULL,		excludeFullName },
...
const char *idFileSystemLocal::OSPathToRelativePath( const char *OSPath ) {
	...
	// "//Purgatory/purgatory/doom/base/models/mapobjects/milwaukee_moveables/RedHatDiffuse.tga"
...
idFile *idFileSystemLocal::OpenFileReadFlags( const char *relativePath, int searchFlags, pack_t **foundInPak, bool allowCopyFiles, const char* gamedir ) {
	...
	// make sure the icaruskey file is only readable by game at initialization
...
void idFileSystemLocal::FindMapScreenshot( const char *path, char *buf, int len ) {
	...
	if ( ReadFile( buf, NULL, NULL ) == -1 ) {
		...
		if ( file ) {
			...
			idStr::Copynz( buf, "textures/images_used_in_source/default_map_splashscreen.tga", len );
		}
	}
}
