...
const int WIN_ALLOWMULTISELECT	= 0x02000000; // 0000 0010 0000 0000 0000 0000 0000 0000
...
const char DEFAULT_TEXTSCALE[] = "0.8";
...
public:
	...
	bool		allow_multiselect_box_events;
	// boyette space command end
...
protected:
	...
	idWinFloat		background_parm11;
	idWinStr	tooltip_text;
	...
	bool		has_custom_parm11; // BOYETTE NOTE TODO: Not sure if this is necessary - I think winvarfloat might to null if background_parm11 isn't specified in a window - so we can just do a if( background_parm11 ) check. Also gui's materials probably don't use parm 11 in any way so it wouldn't affect anything as of right now.
};
